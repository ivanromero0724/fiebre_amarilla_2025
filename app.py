...
st.markdown(f"""
    ...
    <p style='text-align: center; font-size: 14px;margin-bottom: 0px;'><b>Porcentaje de viviendas georreferenciadas:</b> {porcentaje_geo:.1f}% ({viviendas_geo} de {total_viviendas})</p>
    <p style='text-align: center; font-size: 14px;'><b>Porcentaje de casos de Fiebre Amarilla georreferenciados:</b> {porcentaje_geo_fa:.1f}% ({casos_geo_fa} de {casos_geo_fa_total})</p>
""", unsafe_allow_html=True)
