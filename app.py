...
st.markdown(f"""
    ...
    <p style='text-align: center; font-size: 14px;margin-bottom: -5px;'><b>Última fecha de actualización:</b> 16/02/2025</p>
    <p style='text-align: center; font-size: 14px;margin-bottom: -5px;'><b>Porcentaje de viviendas georreferenciadas:</b> {porcentaje_geo:.2f}% ({viviendas_geo} de {total_viviendas})</p>
