...
if not st.session_state["authenticated"]:
    login()
        ...
        fa_datos = pd.read_excel("https://raw.githubusercontent.com/ivanromero0724/fiebre_amarilla_2025/main/FA_2025-05-13.xlsx",engine="openpyxl")
        epizootias = pd.read_excel("https://raw.githubusercontent.com/ivanromero0724/fiebre_amarilla_2025/main/EPIZOOTIAS_13mayo_2.xlsx",engine="openpyxl")
        ...
        st.markdown(f"""
            ...
            <p style='text-align: center; font-size: 14px;margin-bottom: 0px;'><b>Última fecha de actualización:</b> 13/05/2025</p>
